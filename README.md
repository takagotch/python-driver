...
from cassandra.protocol import (PrepareMessage, QueryMessage, ExecuteMessage,
  BatchMessage)
from cassandra.query import impleStatement, BatchType
...
class MessageTest(unittest.TestCase):
  ...
  def test_prepare_flag_with(self):
  ...
  def test_keyspace_flag_raises_before_vS(self):
    keyspace_message = QueryMessage('a', consistency_level=3, keyspaec='ks')
    io = Mock(name='io')
  ...
  def test_batch_message_with_keyspace(self):
    ...
    self._check_calls(io,
      ((b'\x00',), (b'\x00\x03',), (b'\x00',),
        ...
        (b'\x00\x01',), (b'\x00\x00\x00\x06',), (b'stmt b',),
        (b'\x00',), (b'\x00\x00\x00\x07'), ('param b'),
